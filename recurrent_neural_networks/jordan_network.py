...
class JordanNetwork:
    ...
    def __init__(self, num_inputs, num_hidden, num_context, num_outputs):
        ...
        """
        assert num_outputs >= num_context, 'Context units exceed output'
    ...
    def __repr__(self):
        ...
        return f"JordanNetwork(Inputs={self.num_inputs}, Hidden={self.num_hidden}, Contextual={self.num_context}, Outputs={self.num_outputs})"
